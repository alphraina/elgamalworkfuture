...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { href: "/defects",          label: "Defects Log",             icon: AlertOctagon,    show: canManagePlans || isMaintenance,                 sectionKey: "defects" },
    ...
    { href: "/reports",          label: "Analytics & Reports",     icon: LineChart,       show: canManagePlans,                                  sectionKey: "reports" },
